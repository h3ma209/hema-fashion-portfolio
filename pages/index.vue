<template>
    <div class="container" id="scroll" data-scroll-container>
        <div class="landing" data-scroll-section>
            ...
            <div class="name mx-7 font-bold text-5xl lg:text-9xl" data-scroll data-scroll-speed='-1.3'>
                H
            </div>
            <div class="name mx-7 font-bold text-5xl lg:text-9xl" data-scroll data-scroll-speed='-1.6'>
                E
            </div>
            <div class="name mx-7 font-bold text-5xl lg:text-9xl" data-scroll data-scroll-speed='-1.8'>
                M
            </div>
            <div class="name mx-7 font-bold text-5xl lg:text-9xl" data-scroll data-scroll-speed='-1'>
                A
            </div>
        </div>
        ...
        <div class="about" data-scroll-section>
            <div class="flex flex-col sm:flex-row h-full">
                ...
                <div class="grid lg:w-4/5 lg:content-center sm:items-center right p-4">
                    ...
                    <div class="font-normal text-xl lg:text-3xl desc" data-scroll data-scroll-speed='2.7'>
        ...
        <div class="portfolio p-6" data-scroll-section>
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <showcase v-for="dt,i in gallery" :key="i" :number="'0'+(i+1)" :src="dt.src" :caption="dt.caption" :speed="dt.speed" :delay="dt.delay" class="p-2 m-3"></showcase>
            </div>
        </div>
        <Whitespace></Whitespace>
        <Whitespace></Whitespace>
